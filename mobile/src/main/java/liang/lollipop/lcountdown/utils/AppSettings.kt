...
object AppSettings {
    ...
    fun getEndTime(context: Context,id: Int): Long = SharedPreferencesUtils[context, "$KEY_END_TIME$id", System.currentTimeMillis()] ?: System.currentTimeMillis()
    ...
    fun getIds(context: Context): IntArray{
        ...
        return IntArray(idArray.size,{ it -> idArray[it].toInt() })
...
//    fun addIds(context: Context,id: Int){
//        val oldIds = getIds(context)
//        val newIds =
//        setIds(context,)
//    }
