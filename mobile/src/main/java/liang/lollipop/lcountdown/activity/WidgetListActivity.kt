...
import liang.lollipop.lcountdown.databinding.ActivityWidgetListBinding
...
class WidgetListActivity : BaseActivity(), SwipeRefreshLayout.OnRefreshListener {
    ...
    private val binding: ActivityWidgetListBinding by lazyBind()
    ...
    override fun onStart() {
        super.onStart()
        val delayed =
            (System.currentTimeMillis() / WidgetUtil.UPDATE_TIME + 1) * WidgetUtil.UPDATE_TIME
